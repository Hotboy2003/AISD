...
/*В этой лабораторной осуществлена работа через файлы. +какое то число - добавляет число в дерево,
-какое то число - если есть это число, то удаляет его из дерева,
?какое то число - проверяет есть ли это число в дереве и пишет его глубину в дереве
E - закончить работу с файлом

Определение в какую ветку отправляется то или иное число осуществляется автоматически программой. От большего к меньшему.
*/
struct Elem
{
    int data;   //Данные 
